...
?>
    ...
    <form action="/" method="POST">
                ...
                <label>
                    <input type="radio"
                           name="radio-1" value="2" />
                    Female
                </label><br />

                Number of limbs:<br />
                <label>
                    <input type="radio" name="radio-2" value="1" />0
                </label>
                <label>
                    <input type="radio" name="radio-2" value="2" />1
                </label>
                <label>
                    <input type="radio" name="radio-2" value="3" />2
                </label>
                <label>
                    <input type="radio" name="radio-2" value="4" />3
                </label>
                <label>
                    <input type="radio" checked="checked" name="radio-2" value="5" />4
                </label><br />
